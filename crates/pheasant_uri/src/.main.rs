use pheasant_uri::{Parse, PathRelativeUrl, SchemeRelativeUrl, Url, Urn};
...
fn main() {
    ...
    // let uri = "/en-US/docs/Learn_web_development/////?ac&e=r34";
    ...
    let mut url = uri.parse::<SchemeRelativeUrl>().unwrap();
    url.align_port(88);
    println!("{:#?}", url);
}
