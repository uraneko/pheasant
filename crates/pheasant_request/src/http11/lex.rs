...
// TODO
// Data can be just &[u8] or Vec<u8> if the former is painful to deal with
// Token should hold no data
// lex then parse
...
impl Parser {
    ...
    fn next(&mut self) -> Option<(Token, &[u8])> {}
