use crate::Response;
use pheasant_middleware::ToHeader;
use pheasant_middleware::{ContentEncodingBits, EncodeBody, Encoding};
use pheasant_middleware::{ContentType, SetContentLength, SetDate};
